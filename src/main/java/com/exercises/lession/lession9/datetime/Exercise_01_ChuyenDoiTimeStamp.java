package com.exercises.lession.lession9.datetime;

public class Exercise_01_ChuyenDoiTimeStamp {
...
//	4. Viết hàm tính số giây từ ngày 1 đến ngày đang xét.
	...
	public static void main(String[] args) {
		...
		long timestamp = Exercise_01_ChuyenDoiTimeStamp.getUnixTimeFromDate(21, 8, 2021, 1, 2, 3);
		System.out.println(timestamp);

		int[] date = Exercise_01_ChuyenDoiTimeStamp.getDateFromUnixTime(timestamp);
		System.out.format("%d/%d/%d %d:%d:%d", date[0], date[1], date[2], date[3], date[4], date[5]);
		System.out.println("\n===================\n");

		timestamp = Exercise_01_ChuyenDoiTimeStamp.getUnixTimeFromDate(15, 1, 1999, 7, 8, 9);
		System.out.println(timestamp);
		date = Exercise_01_ChuyenDoiTimeStamp.getDateFromUnixTime(timestamp);
		System.out.format("%d/%d/%d %d:%d:%d", date[0], date[1], date[2], date[3], date[4], date[5]);
		System.out.println("\n===================\n");

		timestamp = Exercise_01_ChuyenDoiTimeStamp.getUnixTimeFromDate(30, 12, 2001, 7, 8, 59);
		System.out.println(timestamp);
		date = Exercise_01_ChuyenDoiTimeStamp.getDateFromUnixTime(timestamp);
		System.out.format("%d/%d/%d %d:%d:%d", date[0], date[1], date[2], date[3], date[4], date[5]);
		System.out.println("\n===================\n");
