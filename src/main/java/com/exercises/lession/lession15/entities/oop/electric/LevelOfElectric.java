...
public class LevelOfElectric {
	enum RetailLevelOfElectric { // enum của bậc điện sinh hoạt bán lẻ
		LEVEL1(50, 1678), LEVEL2(50, 1734), LEVEL3(100, 2014), LEVEL4(100, 2536), LEVEL5(100, 2834), LEVEL6(2927);
	...
	enum WholesaleLevelOfElectric { // enum của bậc điện sinh hoạt bán sỉ
		LEVEL1(50, 1403), LEVEL2(50, 1459), LEVEL3(100, 1590), LEVEL4(100, 1971), LEVEL5(100, 2231), LEVEL6(2323);
