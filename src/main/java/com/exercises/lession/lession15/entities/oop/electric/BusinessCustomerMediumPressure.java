...
public class BusinessCustomerMediumPressure extends BusinessCustomer {
	...
	public BusinessCustomerMediumPressure(String ID, String name, String phone, double idleElectricNumber,
			double nomalElectricNumber, double rushElectricNumber) {
